...
export const ApiKeyManager: React.FC<ApiKeyManagerProps> = ({ apiKeys, selectedApiKey, onAddKey, onDeleteKey, onSelectKey }) => {
  ...
  return (
    <div className="bg-dark-card rounded-2xl border border-dark-border shadow-2xl">
      ...
      >
        <span className="text-lg font-semibold text-brand-primary">Quản lý khóa API</span>
        <svg
      ...
      {isOpen && (
        <div className="p-6 pt-2 space-y-4">
          ...
          <div className="space-y-2">
           ...
           {apiKeys.length > 0 && (
            <div>
              <h4 className="text-sm font-medium text-dark-subtle mb-2">Quản lý các khóa:</h4>
          ...
          <p className="text-xs text-dark-subtle italic text-center pt-2">Các khóa API của bạn được lưu trữ an toàn trong bộ nhớ cục bộ của trình duyệt và không bao giờ được gửi đi nơi khác.</p>
        </div>
      )}
    </div>
  );
